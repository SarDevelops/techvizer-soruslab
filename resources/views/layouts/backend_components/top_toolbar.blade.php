...
<div class="flex-shrink-0 app-navbar">
    ...
    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        $image_url = isset($admin->profile) ?
        asset('uploads/user_profile/'.$admin->image_folder.'/'.$admin->profile) :'';
        @endphp
        <!--begin::Menu wrapper-->
        <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
            data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
            data-kt-menu-placement="bottom-end">
            <img src="{{ ($admin->profile == NULL) ? asset('theme/dist/assets/media/avatars/default_user.png') : $admin->profile_url }}"
                alt="user" />
        </div>
        ...
        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px"
            ...
            <div class="px-3 menu-item">
                <div class="px-3 menu-content d-flex align-items-center">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img alt="Logo"
                            src="{{ ($admin->profile == NULL) ? asset('theme/dist/assets/media/avatars/default_user.png') : $admin->profile_url }}" />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Username-->
            ...
            <!--begin::Menu item-->
            <div class="px-5 menu-item">
                <a href="{{ route('admin.logout') }}" class="px-5 menu-link">Sign Out</a>
            </div>
