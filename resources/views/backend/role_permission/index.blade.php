...
@section('page_heading', 'Role Permissions List')
@section('Breadcrumb')
	<ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
		...
		<!--end::Item-->
		<!--begin::Item-->
		<li class="breadcrumb-item text-muted">Role Permissions List</li>
		<!--end::Item-->
	</ul>
@endsection
	...
	<div id="kt_content_container" class="container-xxl">
		...
		<div class="card">
			...
			<div class="pt-6 border-0 card-header">
				...
				<div class="card-toolbar">
					...
					<div class="d-flex justify-content-end table-action-buttons" data-kt-user-table-toolbar="base">
						...
						<button type="button" class="btn btn-primary open-user-form me-3" target-url="{{ route('admin.role_permissions.create') }}" target-header="Add Role Permission" title="Add New">
					...
					<div class="d-flex justify-content-end align-items-center d-none delete-all-button-div" data-kt-user-table-toolbar="selected">
						...
						<button type="button" class="btn btn-danger" data-kt-user-table-select="delete_selected" target-url="{{ route('admin.role_permissions.destroy', ['role_permission' => 0]) }}">Delete Selected</button>
					</div>
					<!--end::Group actions-->
				</div>
				<!--end::Card toolbar-->
			...
			<div class="pt-0 card-body">
				<!--begin::Table-->
				<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_role_permission">
					<!--begin::Table head-->
					<thead>
						<!--begin::Table row-->
						<tr class="text-center text-muted fw-bolder fs-7 text-uppercase gs-0">
							<th class="w-10px pe-2">
								<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
									<input class="form-check-input" type="checkbox" id="selectAll" data-kt-check="true" data-kt-check-target="#kt_table_role_permission td:first-child input[type='checkbox']" value="1" />
								</div>
							</th>
							<th class="" width="30%">Role Name</th>
							<th class="" width="50%">Permissions</th>
...
<script type="text/javascript">
	var role_permission_listing_route = "{{ route('admin.role_permissions.index') }}";
</script>
{{-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.5/jquery.validate.min.js"></script> --}}
<script src="{{ asset('theme/dist/assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
<script src="{{ asset('backend/js/role_permission/role_permission.js') }}"></script>
@endsection
