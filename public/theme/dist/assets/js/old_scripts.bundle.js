...
var KTApp = function() {
	...
	return {
		init: function() {
			this.initPageLoader(), this.initBootstrapTooltips(), this.initBootstrapPopovers(), this.initBootstrapScrollSpy(), this.initButtons(), this.initCheck(), this.initSelect2(), this.initCountUp(), this.initCountUpTabs(), this.initAutosize(), this.initTinySliders(), this.initSmoothScroll(), this.initBootstrapToast()
		},
		...
		initSelect2: function() {
			"undefined" != typeof jQuery && [].slice.call(document.querySelectorAll('[data-control="select2"], [data-kt-select2="true"]')).map((function(e) {
				var t = {
...
"undefined" != typeof module && (module.exports = KTTablesWidget1), KTUtil.onDOMContentLoaded((function() {
