...
@section('page_title', 'Test Deatis')
@section('content')
<div class="container">
    ...
    <div class="detail">
        <div class="container">
            <div class="row">
                ...
                <div class="mt-5 col-md-8 my-md-0">
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td>Sample Type</td>
                                    <td class="space"> : </td>
                                    <td class="dark">{{ $test->type }}</td>
                                </tr>
                                <tr>
                                    <td>Recommended for</td>
                                    <td class="space"> : </td>
                                    @php
                                        $jsonString = $test->recommended_for;
                    ...
                    <div class="overview-box ml-md-4">
                        ...
                        <p>The doctor may suggest a CBC test if a person experiencing symptoms like: <br><br>
                            @php
                                $jsonString = $test->cbc_test;
                                $dataArray = json_decode($jsonString, true);
                            @endphp
